...
template <class Config, class Allocator>
// gfx906 port: one buffer (the projection; the port's causal_conv1d_silu_split writes q|k|v
// straight into the recurrent inputs). `tp` halves the channel width for a per-rank buffer.
