...
// fp16 V storage (upstream 21a0e85f / port pick 35a9c5aa): the V plane of a bf16 KV cache is
// FP16_RNE(bf16 input); K stays bf16. The bits vector keeps its v_bf16 name.
