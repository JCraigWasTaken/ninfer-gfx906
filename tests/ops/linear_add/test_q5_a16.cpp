...
int q5_a16_conformance() {
    ...
    constexpr std::array<std::int32_t, 8> kK6144RouteInteriors{1, 4, 5, 8, 24, 40, 96, 256};
    ...
    constexpr std::array<std::int32_t, 8> kK17408RouteInteriors{1, 4, 5, 8, 24, 40, 96, 256};
    failures += ninfer::test::linear_add::run_shape(
        "Q5_A16 LinearAdd", WeightFormat::Q5G64F16S,
